      ...
      <div className="container mx-auto px-4">
        <div className="text-center space-y-4 mb-16 animate-fade-up">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Get started with complete digital protection in four simple steps.
          </p>
        </div>
          ...
          {steps.map((step, index) => (
            ...
            >
              <div className="flex-shrink-0">
                <div className="h-16 w-16 rounded-2xl bg-gradient-hero flex items-center justify-center text-white font-bold text-xl shadow-glow">
                  {step.number}
                </div>
              </div>
